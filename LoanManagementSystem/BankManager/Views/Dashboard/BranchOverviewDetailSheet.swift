                ...
                VStack(spacing: LMSSpacing.xl) {
                    ...
                    VStack(alignment: .leading, spacing: LMSSpacing.md) {
                        ...
                        VStack(spacing: 0) {
                            ...
                            Divider().padding(.leading, LMSSpacing.lg)
                            metricRow(title: "Total Recovered", value: CurrencyFormatter.shared.format(overview.totalRecovered))
                            Divider().padding(.leading, LMSSpacing.lg)
                            metricRow(title: "Non-Performing Loan Rate", value: String(format: "%.1f%%", overview.nplRate * 100))
                            Divider().padding(.leading, LMSSpacing.lg)
